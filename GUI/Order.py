...
class Order(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.layout.addWidget(self.order_type_label, 2, 0, 1, 1)
        self.layout.addWidget(self.order_type_combo, 2, 1, 1, 3)
